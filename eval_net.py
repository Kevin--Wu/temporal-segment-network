...
sys.path.append('/home/hadoop/whx/temporal-segment-networks')
...
parser.add_argument('--rgb_prefix', type=str, help="prefix of RGB frames", default='frame')
